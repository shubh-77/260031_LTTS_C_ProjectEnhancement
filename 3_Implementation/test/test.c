...
void test_annual_deposit(void){
      TEST_ASSERT_EQUAL(1210.00,calculate_annual_deposit(1000.00,0.1,2));
      TEST_ASSERT_EQUAL(12100.00,calculate_annual_deposit(10000.00,0.1,2));
      TEST_ASSERT_EQUAL(121000.00,calculate_annual_deposit(100000.00,0.1,2));
      TEST_ASSERT_EQUAL(0.00,calculate_annual_deposit(0.00,0.1,2));
}
